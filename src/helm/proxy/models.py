...
ALL_MODELS = [
    ...
    Model(
        group="huggingface",
        creator_organization="BigScience",
        name="huggingface/bloom_1b1",
        display_name="BLOOM (1B1)",
        # From https://bigscience.huggingface.co/blog/bloom
        description="BLOOM (1B1 parameters) is an autoregressive model similar to GPT-3 trained "
        "on 46 natural languages and 13 programming languages.",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, ABLATION_MODEL_TAG],
    ),
    Model(
        group="huggingface",
        creator_organization="BigScience",
        name="huggingface/bloom_3b",
        display_name="BLOOM (3B)",
        # From https://bigscience.huggingface.co/blog/bloom
        description="BLOOM (3B parameters) is an autoregressive model similar to GPT-3 trained "
        "on 46 natural languages and 13 programming languages.",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, ABLATION_MODEL_TAG],
    ),
    Model(
        group="huggingface",
        creator_organization="BigScience",
        name="huggingface/bloom_7b1",
        display_name="BLOOM (7B1)",
        # From https://bigscience.huggingface.co/blog/bloom
        description="BLOOM (7B1 parameters) is an autoregressive model similar to GPT-3 trained "
        "on 46 natural languages and 13 programming languages.",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, ABLATION_MODEL_TAG],
    ),
    Model(
        group="huggingface",
        creator_organization="BigScience",
        name="huggingface/bloomz_1b1",
        display_name="BLOOMZ (1B1)",
        # From https://bigscience.huggingface.co/blog/bloom
        description="BLOOMZ (1B1 parameters) is an autoregressive model similar to GPT-3 trained "
        "on 46 natural languages and 13 programming languages.",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, ABLATION_MODEL_TAG],
    ),
    Model(
        group="huggingface",
        creator_organization="BigScience",
        name="huggingface/bloomz_3b",
        display_name="BLOOMZ (3B)",
        # From https://bigscience.huggingface.co/blog/bloom
        description="BLOOMZ (3B parameters) is an autoregressive model similar to GPT-3 trained "
        "on 46 natural languages and 13 programming languages.",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, ABLATION_MODEL_TAG],
    ),
    Model(
        group="huggingface",
        creator_organization="Saleforce",
        name="huggingface/codegen_2b_nl",
        display_name="CODEGEN (2B NL)",
        # From https://bigscience.huggingface.co/blog/bloom
        description="CODEGEN (2B NL)",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, ABLATION_MODEL_TAG],
    ),
    Model(
        group="huggingface",
        creator_organization="mtk",
        name="huggingface/to_be_evaluated",
        display_name="TOBEEVALUATED",
        # From https://bigscience.huggingface.co/blog/bloom
        description="Trained model to be evaluated",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, ABLATION_MODEL_TAG],
    ),
    Model(
        group="together",
