...
class HuggingFaceServer:
    def __init__(self, model_name: str):
        ...
        with htrack_block("Loading model"):
            ...
            self.model = ModelDeployment(argparse.Namespace(**self.args), True)
    ...
    def serve_request(self, raw_request: Dict[str, Any]):
        ...
        output = self.model.generate(text=[raw_request["prompt"]], generate_kwargs={**self.args['generate_kwargs'], **relevant_raw_request})
    ...
    def serve_batched_request(self, batched_raw_request: Dict[str, Any]):
        ...
        batched_output = self.model.generate(text=batched_raw_request["prompt"], generate_kwargs={**self.args['generate_kwargs'], **relevant_raw_request})
...
class HuggingFaceClient(Client):
    ...
    def make_request(self, request: Request) -> RequestResult:
        ...
        raw_request = {
            ...
            "stop_sequences": [model_server_instance.model.model.tokenizer.eos_token],
        }
