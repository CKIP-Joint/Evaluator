# This must be run first before helm
import nltk
nltk.data.path.append('nltk_data')
# Copy wanted from the below sections
from .scenarios import boolq_scenario  # noqa
from .scenarios import quac_scenario  # noqa
from .scenarios import drcd_scenario  # noqa
from .scenarios import fgc_scenario  # noqa
from .scenarios import tcwsc_scenario  # noqa
from .scenarios import tcic_scenario  # noqa
from .scenarios import sltp_scenario  # noqa
from .scenarios import ttqa_scenario  # noqa
from .scenarios import lambada_scenario  # noqa
from .scenarios import flud_scenario  # noqa
